...
if (JFactory::getApplication()->get('jquery')) $sfl_jquery = 1;

if ($sfl_jquery == 0) {
	if ($sfl_jqueryinclude == 0)
		$document->addScript( $sfl_basepath."tmpl/jquery-".$sfl_jqueryver.".min.js" );
	else
		echo '<script type="text/javascript" src="'.$sfl_basepath.'tmpl/jquery-".$sfl_jqueryver.".min.js"></script>';
...
<?php if ($sfl_jqueryver === "1.4.3") {
	echo "jQuery('#sfl_ARefresh').live('click', function() {";
} else {
	echo "jQuery(document).on('click', '#sfl_ARefresh', function() {";
} ?>
//jQuery('#sfl_ARefresh').live('click', function() {
//jQuery(document).on('click', '#sfl_ARefresh', function() {
...
<?php if ($sfl_jqueryver === "1.4.3") {
	echo "jQuery('.sfl_btnBrowseDir').live('click', function() {";
} else {
	echo "jQuery(document).on('click', '.sfl_btnBrowseDir', function() {";
} ?>
//jQuery('.sfl_btnBrowseDir').live('click', function() {
//jQuery(document).on('click', '.sfl_btnBrowseDir', function() {
	var dir = this.rel;
...
<?php if ($sfl_jqueryver === "1.4.3") {
	echo "jQuery('.sfl_btnDelete').live('click', function() {";
} else {
	echo "jQuery(document).on('click', '.sfl_btnDelete', function() {";
} ?>
//jQuery('.sfl_btnDelete').live('click', function() {
//jQuery(document).on('click', '.sfl_btnDelete', function() {
	var del = this.rel;
...
<?php if ($sfl_jqueryver === "1.4.3") {
	echo "jQuery('#sfl_ASortDesc').live('click', function() {";
} else {
	echo "jQuery(document).on('click', '#sfl_ASortDesc', function() {";
} ?>
//jQuery('#sfl_ASortDesc').live('click', function() {
//jQuery(document).on('click', '#sfl_ASortDesc', function() {
...
<?php if ($sfl_jqueryver === "1.4.3") {
	echo "jQuery('#sfl_ASortAsc').live('click', function() {";
} else {
	echo "jQuery(document).on('click', '#sfl_ASortAsc', function() {";
} ?>
//jQuery('#sfl_ASortAsc').live('click', function() {
//jQuery(document).on('click', '#sfl_ASortAsc', function() {
...
<?php if ($sfl_jqueryver === "1.4.3") {
	echo "jQuery('#sfl_btnNext').live('click', function() {";
} else {
	echo "jQuery(document).on('click', '#sfl_btnNext', function() {";
} ?>
//jQuery('#sfl_btnNext').live('click', function() {
//jQuery(document).on('click', '#sfl_btnNext', function() {
...
<?php if ($sfl_jqueryver === "1.4.3") {
	echo "jQuery('#sfl_btnPrev').live('click', function() {";
} else {
	echo "jQuery(document).on('click', '#sfl_btnPrev', function() {";
} ?>
//jQuery('#sfl_btnPrev').live('click', function() {
//jQuery(document).on('click', '#sfl_btnPrev', function() {
	var params = '';
